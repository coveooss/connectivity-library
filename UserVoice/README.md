...
This guide explains how you can use the content of the [`SourceJSONConfig.json`](SourceJSONConfig.json) file in a [REST API source](https://docs.coveo.com/en/1896/) to index suggestions. Your Coveo source will use this JSON configuration to customize HTTP requests for the UserVoice Admin v1 API and identify the specific content to extract from the responses.
