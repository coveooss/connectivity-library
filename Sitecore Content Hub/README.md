...
3. [Create and configure a REST API source](https://docs.coveo.com/en/1896/).
   ...
   4. Add or update the `Endpoints` section according to your data structure in Sitecore Content Hub.
     <p>
   > **_NOTE:_**  See [Understanding the SourceJSONConfig.json file](resources/understanding-the-sourcejsonconfig-json-file.md) for explanations on the key aspects of the configuration.</p>
